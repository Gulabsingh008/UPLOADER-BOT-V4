...
1️⃣ 𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺 — ʀᴇᴇʟꜱ, ᴘᴏꜱᴛꜱ, ɪɢᴛᴠ, ꜱᴛᴏʀɪᴇꜱ  
2️⃣ 𝗧𝗶𝗸𝗧𝗼𝗸 — ᴠɪᴅᴇᴏꜱ ᴡɪᴛʜᴏᴜᴛ ᴡᴀᴛᴇʀᴍᴀʀᴋ  
3️⃣ 𝗫 (𝗧𝘄𝗶𝘁𝘁𝗲𝗿) — ᴍᴇᴅɪᴀ, ɢɪꜰꜱ, ᴠɪᴅᴇᴏꜱ  
4️⃣ 𝗣𝗶𝗻𝘁𝗲𝗿𝗲𝘀𝘁 — ɪᴍᴀɢᴇꜱ & ᴠɪᴅᴇᴏꜱ  
5️⃣ 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 — ᴠɪᴅᴇᴏꜱ ᴀɴᴅ ᴍᴏʀᴇ...

⚡ ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴀ ᴠᴀʟɪᴅ ᴜʀʟ ᴀɴᴅ ʟᴇᴛ ᴍᴇ ᴅᴏ ᴛʜᴇ ᴍᴀɢɪᴄ!  
🎯 ꜱᴜᴘᴘᴏʀᴛꜱ ᴍᴜʟᴛɪᴘʟᴇ ꜰᴏʀᴍᴀᴛꜱ, ᴀᴜᴅɪᴏ, ᴠɪᴅᴇᴏ & ʜᴅ ǫᴜᴀʟɪᴛʏ...

💡 ᴘᴀꜱᴛᴇ ᴀ ʟɪɴᴋ ᴛᴏ ꜱᴛᴀʀᴛ ⬇️
"""
...
├🚨 **Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ** : <a href=https://t.me/>wait....</a>
├🥏 **Cʜᴀɴɴᴇʟ** : <a href=https://t.me/+OiKmB79YlMJmNTJl>Bᴏᴛ Cʜᴀɴɴᴇʟ</a>
...
"""
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Join : @Af_mhakal \n For the list of Telegram bots. "
